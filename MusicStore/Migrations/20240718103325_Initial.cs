        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaINome = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Resumo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InstrumentoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstrumentoNome = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    Resumo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ResumoDetalhada = table.Column<string>(type: "nvarchar(800)", maxLength: 800, nullable: false),
